...
# Draw plot
ggplot(hospExp, aes(x=State, y=ASPE_State)) + 
...
ggplot(hosp_midwest, aes(x=State, y = ASPE_State, color = State))+
  geom_histogram(stat = "Identity")+
  xlab("Hospital Name")+
  ylab("Average Spending Per Episode Hospital")+
  scale_y_continuous(labels=fancy_scientific)
...
ggplot(hosp_south, aes(x=State, y = ASPE_State, color = State))+
  geom_histogram(stat = "Identity")+
  xlab("State")+
  ylab("ASPE_State")+
  scale_y_continuous(labels=fancy_scientific)
...
ggplot(hosp_west, aes(x=State, y = ASPE_State, color = State))+
  geom_histogram(stat = "Identity")+
  xlab("State")+
  ylab("ASPE_State")+
  scale_y_continuous(labels=fancy_scientific)
