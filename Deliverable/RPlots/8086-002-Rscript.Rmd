...
2. Finding the leading hospital in terms of spending based on the US zones and also finding the differences in spending by hospital on zone level?  
3. Finding the amount spent in each state and grouping it under highest and lowest claim states?
...
## 2.2 Highest spending hospital in USA
